...
(function () {
	...
	var Drawing = useSVG ? svgDrawer : !_isSupportCanvas() ? (function () {
		...
		var Drawing = function (el, htOption) {
			...
			this._elCanvas.width = htOption.width; //Sinan
			this._elCanvas.height = htOption.height*2; //Sinan
...
_oContext.fillText("____________________", 0, nCount+340);
	...
	QRCode.prototype.makeCode = function (sText, urlbikeID, urlbikePIN, urlbikeFrame, urlbikeMfgdt, urlbikeModel,urlbikeColor,urlLockCode ) {
		...
		this._oDrawing._ourlQRText = sText;
		this._oDrawing._ourlbikeID = urlbikeID;
		this._oDrawing._ourlbikePIN = urlbikePIN;
		this._oDrawing._ourlbikeFrame = urlbikeFrame;
